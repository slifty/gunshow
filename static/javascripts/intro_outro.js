$(document).ready(function() {
  // intro video
  var intro = Popcorn.vimeo('#intro-vid', 'http://player.vimeo.com/video/66370342?autoplay=1');
  intro.autoplay(true);


  intro.cue(15.5, function() {
    $("#intro-title").show(1000);
  });

  intro.cue(24, function() {
    $("#intro-title").hide(1000);
  });

  intro.cue(25, function() {
    $("#intro-input").show(1000);
  });

  $("#intro-input .button").click(function() {
